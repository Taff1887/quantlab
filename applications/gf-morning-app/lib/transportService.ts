...
function buildScheduleOptions(bh: number, bm: number): TransportOption[] {
  ...
  return [
    ...
    },
    {
      ...
      driveMins: 3,
      driveDistanceM: 280,
      departureTime: toTime(...addMins(bh, bm, 7)),
      arrivalTime: toTime(...addMins(bh, bm, 37)),
      totalMins: 37,
      notes: "Direct to Wynyard via Neutral Bay",
      isBest: false,
    },
    {
      id: "bus-178",
      ...
      arrivalTime: toTime(...addMins(bh, bm, 42)),
      totalMins: 42,
      notes: "Express to City via Spit Bridge",
    },
  ];
}
